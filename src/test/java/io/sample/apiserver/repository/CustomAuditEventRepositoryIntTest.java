package io.sample.apiserver.repository;

import io.sample.apiserver.SampleApp;
import io.sample.apiserver.config.Constants;
import io.sample.apiserver.config.audit.AuditEventConverter;
import io.sample.apiserver.domain.PersistentAuditEvent;
...
import static io.sample.apiserver.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
